...
from django_thumbor_pagtech import conf
...
def generate_url(image_url, alias=None, **kwargs):
    ...
    if conf.THUMBOR_SERVER_IS_RUNNING != 'on':
        return image_url
        
    image_url = urllib.parse.quote(image_url) # Thumbor only understands properly encoded URIs.
